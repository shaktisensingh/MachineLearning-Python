# This network contains two input nodes, one output node and no hidden layers. Examples: AND, OR gate
...
def main():
    ...
    for i in np.arange(5000):
        ...
        dz = a - y                                                  # Partial derivative of error wrt Linear activarion
